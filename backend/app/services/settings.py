...
def save_app_settings(session: Session, value: dict[str, Any]) -> dict[str, Any]:
    ...
    if not value.get("dola_auth_cookies") and current.get("dola_auth_cookies"):
        next_value["dola_auth_cookies"] = current.get("dola_auth_cookies", "")
