...
@pytest.mark.asyncio
async def test_launch_slot_converts_manager_500_to_browser_error(monkeypatch: pytest.MonkeyPatch) -> None:
    class FakeResponse:
        status_code = 500
        is_error = True
        text = "failed"
        ...
        def json(self) -> dict[str, object]:
            return {
                ...
                "slot_id": "slot-1",
                "profile_dir": "/data/browser-profile/vpn-slots/a/slots/slot-1",
                "log_file": "/data/logs/chromium-slot-1.log",
